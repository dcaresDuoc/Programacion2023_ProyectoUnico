...
export class RegisterComponent implements OnInit {
  ...
  formSubmit(): void {
    ...
    this.user.nombre = this.capitalizeFirstLetter(this.var_nombre + ' ' + this.var_apellido);
  ...
  isFormValid(): boolean {
    ...
    if (!this.var_nombre || !this.var_apellido || !this.user.rut || !this.user.email || !this.user.telefono) {
      Swal.fire({
        icon: 'error',
        title: 'Error',
